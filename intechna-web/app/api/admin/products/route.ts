...
import { deleteProduct, getProducts, upsertProduct } from '@/app/lib/db/queries'
...
export async function POST(request: Request) {
  ...
  const product = {
    ...
    categorySlug: body.categorySlug || 'switch',
...
export async function DELETE(request: Request) {
  ...
  return NextResponse.json(await deleteProduct(slug))
}
